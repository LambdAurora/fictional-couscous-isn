...
// trace une image de nom donné à la position donné
...
// Stocke une image de nom donné à la position donné
...
// La même mais avec la transparence
...
// Comme la fonction EZ_trace_image sauf que l'on donne l'image déjà chargée
